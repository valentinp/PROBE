...
rosBagFileName = '/Volumes/STARSExFAT/Pioneer-VI/2015-02-25-16-56-01.bag';
...
pathGoodness = norm(translation(:, end))


learnedPredSpace.predVectors = [learnedPredSpace.predVectors usedPredVectors];
learnedPredSpace.weights = [learnedPredSpace.weights pathGoodness*ones(1, size(usedPredVectors,2))];
...
%% Plot Trajectories 
close all
load('learnedProbeModels/2015-02-25-16-56-01_learnedPredSpaceIter10.mat')
figure
...
save(sprintf('plots/%s_paths.mat', fileName), 'p_wcam_hist');
